...
rain_db <- read.csv(file="C:/Users/user/Documents/GYC/Tangki NAHRIM/R/rainfall_pm_clean6d.csv",
                    header = TRUE, sep=",")
raindata <- rain_db %>%
